...
\begin{document}
	...
	\begin{itemize}
		...
		\item Algorithmic Problem Solving (\href{https://www.stopstalk.com/user/profile/ovebepari}{340+ and counting}), InfoSec Security Contests (\href{https://tryhackme.com/p/dovi}{dovi-0x06 @THM})
	\end{itemize}
