...
\begin{document}
	...
	\begin{itemize}
		\item TicketBD, an online bus ticket selling platform (failed for bad hosting provider, bad uptime) that lauched on Sayedabad, Dhaka to sell bus tickets, online. A PHP backend Web application.
