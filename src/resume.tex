...
\begin{document}
	...
	\begin{itemize}
		\item C++, Python, GNU/Linux systems (5+ years), Web Frameworks (Django, Flask) and MVC architecture, Apache, Git, OSI Layers, Database \& DBMS. I notice and enjoy other's design choices (UI/UX, System Architecture, Typography etc)
		\item Algorithmic Problem Solving (\href{https://www.stopstalk.com/user/profile/ovebepari}{350+ and counting}), InfoSec Security Contests (\href{https://tryhackme.com/p/dovi}{dovi-0x06 @THM})
	\end{itemize}
